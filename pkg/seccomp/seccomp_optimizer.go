...
func extractRepeatedMatchers(rule SyscallRule) (SyscallRule, bool) {
	// We turn off race detection here because this function is very expensive
	// to run in this mode, yet doesn't perform anything crazy or concurrently.
	sync.RaceDisable()
	defer sync.RaceEnable()
